...
function enqueue_main_styles() {
    ...
    wp_enqueue_style( 'landing-style', get_template_directory_uri().'/css/landing.css', array(), filemtime(get_template_directory().'/css/landing.css'), 'all' );
...
add_action('woocommerce_before_shop_loop','alen_fix_shop_loop_total',5);
function alen_fix_shop_loop_total(){ if(!wc_get_loop_prop('total')){ global $wp_query; if(isset($wp_query)&&$wp_query->found_posts) wc_set_loop_prop('total',$wp_query->found_posts); } }
